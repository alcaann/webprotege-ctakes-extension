...
public class DefaultDisplayNameSettingsFactory_TestCase {
    ...
    public void shouldCreateDefaultSettingsForEmptyLang() {
        ...
        assertThat(settings.getPrimaryDisplayNameLanguages(), is(ImmutableList.of(DictionaryLanguageData.rdfsLabel(""),
    ...
    public void shouldCreateDefaultSettingsForNonEmptyLang() {
        ...
        assertThat(settings.getPrimaryDisplayNameLanguages(), is(ImmutableList.of(DictionaryLanguageData.rdfsLabel("en-GB"),
