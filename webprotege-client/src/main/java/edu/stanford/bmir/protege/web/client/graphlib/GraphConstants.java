...
public interface GraphConstants {
    ...
    String DATA_EDGES = "data-edges";

    String DATA_TAIL = "data-tail";

    String DATA_HEAD = "data-head";

    String DATA_NODE_ID = "data-node-id";

    String DATA_NODE = "data-node";

    String DATA_EDGE = "data-edge";
